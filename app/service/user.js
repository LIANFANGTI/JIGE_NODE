...
module.exports = class UserService extends Service {
   //赠送金币
    ...
    async list2({mp,page =1 ,size =10}){
        ...
        const total_sql = `SELECT id,mid,openid,subscribe,conn_sign,father_name,nickname,headimgurl,phone,fid,ex_count,recharge_count,get_count,city,sex,times,week_ex,month_ex,all_ex,created_at FROM  users 
